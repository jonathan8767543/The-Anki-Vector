...
async def lego(event):
 ...
 try:
    ...
    fname2 = "AnkiVectorLogo.png"
    img.save(fname2, "png")
    await tbot.send_file(event.chat_id, fname2, caption="Made By @DARK_S_KULL_BOT ⚡️")
    if os.path.exists(fname2):
            os.remove(fname2)
 except Exception as e:
   await event.reply(f'Error Go to Help From  @DARK_SKULL_SUPPORTGROUP, {e}')
...
async def lego(event):
 ...
 try:
    ...
    fname2 = "AnkiVectorLogo.png"
    img.save(fname2, "png")
    await tbot.send_file(event.chat_id, fname2, caption="Made By @DARK_SKULL_SUPPORTGROUP")
    if os.path.exists(fname2):
            os.remove(fname2)
 except Exception as e:
   await event.reply(f'Error Go to Help From  @DARK_SKULL_SUPPORTGROUP, {e}')
...
async def lego(event):
 ...
 try:
    ...
    fname2 = "AnkiVectorLogo.png"
    img.save(fname2, "png")
    await tbot.send_file(event.chat_id, fname2, caption="Made By @DARK_SKULL_SUPPORTGROUP ⚡️")
    if os.path.exists(fname2):
            os.remove(fname2)
 except Exception as e:
   await event.reply(f'Error Go to Help From  @DARK_SKULL_SUPPORTGROUP, {e}')
